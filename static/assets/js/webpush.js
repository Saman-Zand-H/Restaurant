...
window.addEventListener('load', function () {
    ...
    function initialiseState(reg) {
        ...
        if (!(reg.showNotification)) {
            ...
            subBtn.innerHTML = '<i class="far fa-bell"></i> &nbsp; Notifications';
        ...
        if (Notification.permission === 'denied') {
            // Show a message and activate the button
            subBtn.innerHTML = '<i class="far fa-bell"></i> &nbsp;' + gettext('Notifications');
                    ...
                    postSubscribeObj('subscribe', subscription,
                        function (response) {
                            ...
                            if (response.status === 201) {
                                ...
                                subBtn.innerHTML = '<i class="far fa-bell-slash"></i> &nbsp; ' + gettext('Notifications');
                                subBtn.disabled = false;
                                isPushEnabled = true;
                    ...
                    function (response) {
                        ...
                        if (response.status === 202) {
                            ...
                            subscription.unsubscribe()
                                ...
                                .catch(
                                    function (error) {
                                        subBtn.textContent = 'fa-bell-slash' + gettext('Notifications');
